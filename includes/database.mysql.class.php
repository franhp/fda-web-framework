 ...
 * 
 * Permite la creaci�n de conexiones con la base de datos, tiene metodos para consultar y volcar resultados.
 *
...
class mysql {
    ...
    /**
     * Constructor para crea la conexi�n con la base de datos.
     *
     */
    ...
    /**
     * Esta funci�n permite introducir cualquier query
     *
     * Por ejemplo:
    ...
    /**
     * Funci�n que retorna un objeto del tipo stdClass que contiene los datos antes pedidos mediante cualquier funci�n de consulta
     *
     * Por ejemplo:
     * <pre>
     * $db = new Database;
    ...
    /**
     * Funci�n que muestra la Query o su resultado dependiendo del parametro que se le pase
    ...
    /**
     * Funci�n que retorna el numero de filas de una consulta
     * 
     * @return int
     */
    ...
    /**
     * Funci�n que retorna la cadena segura para insertar en la base de datos
     * @param string $text
     */
    ...
    /*
     * Funcion que retorna el primer registro en array
     */
    ...
    /**
     * Funci�n que se desconecta de la base de datos
     */
