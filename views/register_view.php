...
<div id="register-div">
	...
	<form id="register-form">
		...
		<label id="nick-label">Ingresa tu usuario<br><input type="text" id="nick" name="nick" tabindex="1" autocomplete="off" title="Ingrese un nombre de usuario �nico" class=""> <span></span></label>
		
		<label id="passw-label">Contrase&ntilde;a deseada<br><input type="password" id="password" name="password" tabindex="2" autocomplete="off" title="Ingresa una contrase�a segura" class=""> <span></span></label>
		
		<label id="passwc-label">Confirme contrase&ntilde;a<br><input type="password" id="password2" name="password2" tabindex="3" autocomplete="off" title="Vuelve a ingresar la contrase�a" class=""> <span></span></label>
		
		<label id="email-label">Email<br><input type="text" id="email" name="email" tabindex="4" autocomplete="on" title="Ingresa tu direcci�n de email" class=""> <span></span></label>
		
		<label id="date-label">Fecha de nacimiento<br>
		
			<select id="dia" name="dia" tabindex="5" autocomplete="off" title="Ingrese d�a de nacimiento" class=""  style="width: 51px">
			...
			<select id="anio" name="anio" tabindex="7" autocomplete="off" title="Ingrese a�o de nacimiento" class=""  style="width: 70px">
